 ...
 *
 * @version
 * 3.0.9 (Thu, 22 May 2014 17:58:36 GMT)
 *
 * @copyright
...
/**
 * Finds highlighter's DIV shcontainer.
 * @param {String} highlighterId Highlighter ID.
 ...
 * Equivalent to jQuery's $(shcontainer).find(".className")
 ...
 * This is an alias to <code>findElement(shcontainer, className, true)</code>.
 * @param {Element} target Target element.
...
function quickCodeHandler(e)
{
	var target = e.target,
		...
		shcontainer = findParentElement(target, '.shcontainer'),
		textarea = document.createElement('textarea'),
		highlighter
		;

	if (!shcontainer || !highlighterDiv || findElement(shcontainer, 'textarea'))
		return;
	...
	// shcontainer because Firefox loses all \n where as Webkit doesn't.
	var lines = shcontainer.childNodes,
		code = []
		;
	...
	shcontainer.appendChild(textarea);
...
sh.Highlighter.prototype = {
	 ...
	 * @param {String} code     Code to highlight.
	 * @return {Element}        Returns shcontainer DIV element with all markup.
	 */
