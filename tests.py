...
class ManifestTestCase(unittest.TestCase):
    ...
    def test_populate_playbooks(self):
        with patch.object(FirebaseAuthentication, None, return_value='playbook') as mock_FirebaseAuthentication:
        ...
        mock_FirebaseApplication_post.assert_called_once_with(playbook_id + '/playbooks', {'name': play})
